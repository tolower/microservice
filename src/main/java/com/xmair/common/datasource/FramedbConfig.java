package com.xmair.common.datasource;
 ...
 */
@Configuration
@MapperScan(basePackages = "com.xmair.common.mapper.framedb", sqlSessionTemplateRef  = "framedbSqlSessionTemplate")
public class FramedbConfig {
    ...
    public SqlSessionFactory testSqlSessionFactory(@Qualifier("framedbDataSource") DataSource dataSource) throws Exception {
        ...
        bean.setMapperLocations(resolver.getResources("classpath:com/xmair/common/mapper/framedb/xml/*.xml"));
